...
if st.session_state.position is not None and st.session_state.role is not None:
    ...
    df_attack = normalizar_por_90s(st.session_state.stats_players[(st.session_state.stats_players["classification"] == st.session_state.position + " " +st.session_state.role) & (st.session_state.stats_players["market_value_millions"].between(st.session_state.min_valor_mercado, st.session_state.max_valor_mercado))  & (st.session_state.stats_players["age"].between(st.session_state.min_edad, st.session_state.max_edad))][["player","90s"] + attack_metrics])
    df_defense = normalizar_por_90s(st.session_state.stats_players[(st.session_state.stats_players["classification"] == st.session_state.position + " " +st.session_state.role) & (st.session_state.stats_players["market_value_millions"].between(st.session_state.min_valor_mercado, st.session_state.max_valor_mercado))  & (st.session_state.stats_players["age"].between(st.session_state.min_edad, st.session_state.max_edad))][["player","90s"] + defense_metrics])
    df_gk_1 = normalizar_por_90s(st.session_state.stats_players[(st.session_state.stats_players["classification"] == st.session_state.position + " " +st.session_state.role) & (st.session_state.stats_players["market_value_millions"].between(st.session_state.min_valor_mercado, st.session_state.max_valor_mercado))  & (st.session_state.stats_players["age"].between(st.session_state.min_edad, st.session_state.max_edad))][["player","90s"] + goalkeeper_metrics_1])
    df_gk_2 = normalizar_por_90s(st.session_state.stats_players[(st.session_state.stats_players["classification"] == st.session_state.position + " " +st.session_state.role) & (st.session_state.stats_players["market_value_millions"].between(st.session_state.min_valor_mercado, st.session_state.max_valor_mercado))  & (st.session_state.stats_players["age"].between(st.session_state.min_edad, st.session_state.max_edad))][["player","90s"] + goalkeeper_metrics_2])
